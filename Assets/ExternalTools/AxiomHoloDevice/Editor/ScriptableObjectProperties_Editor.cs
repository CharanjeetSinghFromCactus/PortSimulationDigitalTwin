...
[CustomPropertyDrawer(typeof(HoloConfig), true)]
public class ScriptableObjectDrawer : PropertyDrawer
{
  ...
  public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
  {
    ...
    else
    {
      ...
      {
        Debug.LogError("The AxiomHoloCave GameObject needs a HoloDeviceConfig defined in order to work. Please drag and drop the HoloDeviceConfig provided in the Unity Toolkit Assets/Prefab/ folder.");
