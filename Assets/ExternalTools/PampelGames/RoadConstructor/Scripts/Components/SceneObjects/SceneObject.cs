...
namespace PampelGames.RoadConstructor
{
    public abstract class SceneObject : SceneObjectBase
    {
        ...
        public virtual SerializedSceneObject Serialize()
        {
            ...
            return new SerializedSceneObject(road.roadName, elevated, serializedSpawns);
        }
        ...
        public void RemoveTrafficComponent()
        {
            ...
            for (var j = 0; j < trafficLanes.Count; j++) trafficLanes[j].RemoveWaypoints(roadDescr.roadConstructor.pool);
            ObjectUtility.DestroyObject(roadDescr.roadConstructor.pool, traffic.gameObject);
        }
