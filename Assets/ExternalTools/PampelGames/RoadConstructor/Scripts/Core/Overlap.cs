...
namespace PampelGames.RoadConstructor
{
    public class Overlap
    {
        ...
        {
            return exists && overlapType == OverlapType.Road && roadObject.IsSnappedTrack();
        }
        
        public bool IsDirectConnection(RoadDescr railwayDescr)
        {
            if (!railwayDescr.settings.directConnections) return false;
            return IsEndObject() && railwayDescr.road.roadName == intersectionObject.road.roadName;
        }
    }
}