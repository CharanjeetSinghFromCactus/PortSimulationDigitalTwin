...
namespace PampelGames.RoadConstructor
{
    internal static class CustomObjectCreation
    {
            ...
            List<SplineMeshParameter> constructionSplines, List<ConnectionPoint> connectionPoints, bool elevated)
        {
            ...
            var customObj = ObjectUtility.CreateObj(roadDescr.roadConstructor.pool, Constants.PrefixCustom, ShadowCastingMode.On, out var meshFilter, out var meshRenderer);
            ...
            bool elevated, float lodAmount, out List<Material> newMaterials)
        {
            ...
            for (var i = 0; i < constructionSplines.Count; i++)
            {
                ...
                RoadSplineMesh.CreateMultipleSplineMeshes(pool, lanes, parameter, out var roadMeshes, out var roadMaterials);
