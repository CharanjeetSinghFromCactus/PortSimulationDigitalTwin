...
namespace PampelGames.RoadConstructor
{
    internal static class RoundaboutCreation
    {
            ...
            RoundaboutDesign design, float radius)
        {
            ...
            var roundaboutObj = ObjectUtility.CreateObj(roadDescr.roadConstructor.pool, Constants.PrefixRoundabout, roadDescr.road.shadowCastingMode, out var meshFilter,
            ...
            out Material[] combinedMaterials, out List<Spline> roadSplines, out Spline splineMiddle)
        {
            ...
            var pool = roundaboutRoadDescr.roadConstructor.pool;
            ...
            RoadSplineMesh.CreateMultipleSplineMeshes(pool, roundaboutRoadDescr.lanesMiddle, splineMeshParameterMiddle,
            ...
            if (design == RoundaboutDesign.Default)
            {
                ...
                RoadSplineMesh.CreateMultipleSplineMeshes(pool, roundaboutRoadDescr.lanesLeftOffset, splineMeshParameterInside,
            ...
            for (var i = 0; i < meshDatas.Count; i++)
            {
                ...
                RoadSplineMesh.CreateMultipleSplineMeshes(pool, roadDescr.lanesIntersection, splineMeshParameter,
            ...
            void AddOutsideSplineMesh(float tStart, float tEnd)
            {
                ...
                RoadSplineMesh.CreateMultipleSplineMeshes(pool, roundaboutRoadDescr.lanesRightOffset, splineMeshParameter,
