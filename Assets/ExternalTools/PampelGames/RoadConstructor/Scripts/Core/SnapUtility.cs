...
namespace PampelGames.RoadConstructor
{
    internal static class SnapUtility
    {
        ...
        {
            if (road.IsSnappedTrack())
            {
                AlignRoadToIntersection(road, road.SnappedTrackPosition(), width, ref position01, ref tangent01, ref position02, ref tangent02,
                    directConnection);
                return;
            }
