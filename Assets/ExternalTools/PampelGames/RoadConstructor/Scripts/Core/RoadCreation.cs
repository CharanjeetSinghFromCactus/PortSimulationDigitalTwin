...
namespace PampelGames.RoadConstructor
{
    internal static class RoadCreation
    {
        public static RoadObject CreateRoad(RoadDescr roadDescr, Spline spline, bool elevated, bool rampRoad, float lodAmount)
        {
            ...
            var roadObj = ObjectUtility.CreateObj(roadDescr.roadConstructor.pool, Constants.PrefixRoad, roadDescr.road.shadowCastingMode, out var roadMeshFilter, out var roadMeshRenderer);
            ...
            out Material[] materials)
        {
            ...
            return RoadSplineMesh.CreateCombinedSplineMesh(pool, lanes, splineMeshParameter, out materials);
        }
            ...
            out List<Mesh> meshes, out List<Material> materials)
        {
            ...
            RoadSplineMesh.CreateMultipleSplineMeshes(pool, lanes, splineMeshParameter, out meshes, out materials);
        }
            ...
            out MeshFilter roadMeshFilter, out MeshRenderer roadMeshRenderer, float lodAmount)
        {
            ...
            var newSplineMesh = RoadSplineMesh.CreateCombinedSplineMesh(pool, lanes, splineMeshParameter, out var _materials);

            var roadObj = ObjectUtility.CreateObj(pool, Constants.PrefixRoad, road.shadowCastingMode, out roadMeshFilter, out roadMeshRenderer);
        ...
        public static bool TryMergeSplittedRoad(ConstructionObjects constructionObjects, List<RoadObject> roadConnections)
        {
            ...
            if (road01.splitOriginalID != string.Empty && road01.splitOriginalID == road02.splitOriginalID && 
                road01.splitOriginalSpline is {Count: > 0})
            {
