...
namespace PampelGames.RoadConstructor
{
    ...
    {
        public static Mesh CreateCombinedSplineMesh(ConstructionPool pool, List<Lane> lanes, SplineMeshParameter splineMeshParameter,
            out Material[] _materials)
        {
            CreateMultipleSplineMeshes(pool, lanes, splineMeshParameter,
        ...
        public static void CreateMultipleSplineMeshes(ConstructionPool pool, List<Lane> lanes, SplineMeshParameter splineMeshParameter,
