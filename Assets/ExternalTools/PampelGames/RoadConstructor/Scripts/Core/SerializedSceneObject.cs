...
namespace PampelGames.RoadConstructor
{
    ...
    public class SerializedSceneObject
    {
        ...
        public List<SerializedSpawnedObject> spawnedObjects;

        public SerializedSceneObject(string roadName, bool elevated, List<SerializedSpawnedObject> spawnedObjects)
        {
    ...
    [Serializable]
    public class SerializedSpawnedObject
    {
    ...
    public class SerializedRoad : SerializedSceneObject
    {
        ...
        public SerializedRoad(string roadName, bool elevated, List<SerializedSpawnedObject> spawnedObjects, bool rampRoad, Spline spline,
            string splitOriginalID, Spline splitOriginalSpline) : base(roadName, elevated, spawnedObjects)
        {
            this.spline = spline;
    ...
    public class SerializedIntersection : SerializedSceneObject
    {
        ...
        public SerializedIntersection(string roadName, bool elevated, List<SerializedSpawnedObject> spawnedObjects, Vector3 centerPosition,
            List<KnotData> createIntersectionMeshDatas) : base(roadName, elevated, spawnedObjects)
        {
            this.centerPosition = centerPosition;
            connectionRoadNames = new List<string>();
            connectionKnots = new List<BezierKnot>();
            connectionNearestIndexes = new List<int>();
            for (var i = 0; i < createIntersectionMeshDatas.Count; i++)
            {
        ...
        protected List<KnotData> CreateKnotDatas(RoadDescr roadDescr)
        {
            ...
            for (var j = 0; j < connectionRoadNames.Count; j++)
            {
    ...
    public class SerializedRoundabout : SerializedIntersection
    {
        ...
        public SerializedRoundabout(string roadName, bool elevated, List<SerializedSpawnedObject> spawnedObjects, Vector3 centerPosition,
            RoundaboutDesign design, float radius,
            List<KnotData> createIntersectionMeshDatas) : base(roadName, elevated, spawnedObjects, centerPosition, createIntersectionMeshDatas)
        {
            this.design = design;
            this.radius = radius;
        }
    ...
    public class SerializedRamp : SerializedSceneObject
    {
        ...
        public SerializedRamp(string roadName, Vector3 centerPosition, bool elevated, List<SerializedSpawnedObject> spawnedObjects, Spline splineRoad,
            KnotData rampKnotData)
            : base(roadName, elevated, spawnedObjects)
        {
            this.centerPosition = centerPosition;
