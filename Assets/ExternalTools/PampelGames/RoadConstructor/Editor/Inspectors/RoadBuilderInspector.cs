...
namespace PampelGames.RoadConstructor.Editor
{
    ...
    public class RoadBuilderInspector : UnityEditor.Editor
    {
        ...
        private Toggle validateHeight;
        private Toggle validateOverlap;
        ...
        private Toggle alignConnections;
        private Toggle directConnections;
        private Slider tangentLength;
        private Toggle parallelRoad;
        private FloatField parallelDistance;
        private GroupBox RampTypeSettings;
        private Toggle rampDirectConnections;
        ...
        private void FindElements(VisualElement root)
        {
            ...
            validateHeight = root.Q<Toggle>(nameof(validateHeight));
            validateOverlap = root.Q<Toggle>(nameof(validateOverlap));
            ...
            alignConnections = root.Q<Toggle>(nameof(alignConnections));
            directConnections = root.Q<Toggle>(nameof(directConnections));
            ...
            RampTypeSettings = root.Q<GroupBox>(nameof(RampTypeSettings));
            rampDirectConnections = root.Q<Toggle>(nameof(rampDirectConnections));
        ...
        private void BindElements()
        {
            ...
            if (_roadBuilder.roadConstructor)
            {
                ...
                validateHeight.PGSetupBindPropertyRelative(componentSettingsProperty, nameof(validateHeight));
                validateOverlap.PGSetupBindPropertyRelative(componentSettingsProperty, nameof(validateOverlap));
                
                alignConnections.PGSetupBindPropertyRelative(componentSettingsProperty, nameof(RoadConstructor.componentSettings.alignConnections));
                directConnections.PGSetupBindPropertyRelative(componentSettingsProperty, nameof(RoadConstructor.componentSettings.directConnections));
                ...
                rampDirectConnections.PGSetupBindPropertyRelative(componentSettingsProperty, nameof(RoadConstructor.componentSettings.directConnections));
            }
        ...
        private void VisualizeElements()
        {
            ...
            validateHeight.PGToggleStyleDefault();
            validateOverlap.PGToggleStyleDefault();
            ...
            alignConnections.PGToggleStyleDefault();
            directConnections.PGToggleStyleDefault();
            rampDirectConnections.PGToggleStyleDefault();
        ...
        private void DrawButtons()
        {
            ...
            registerSceneObjectsButton.clicked += () =>
            {
                ...
                {
                    if(!constructionParents[i]) continue;
            ...
            recreateRoadSystemButton.clicked += () =>
            {
                if (EditorUtility.DisplayDialog("Recreate Road System", "Are you sure you want to recreate all registered roads?", "Ok", "Cancel"))
                {
                    ...
                    for (var i = 0; i < roadSystem.Count; i++) roadSystem[i].spawnedObjects = null; // Respawn with current settings instead.
        ...
        private void RoadTypeVisibility()
        {
            ...
            RampTypeSettings.PGDisplayStyleFlex(_roadBuilder.builderRoadType == BuilderRoadType.Ramp);
