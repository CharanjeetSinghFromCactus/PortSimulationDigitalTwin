...
namespace PampelGames.Shared.Construction
{
    ...
    public static class SplineCircle
    {
        ...
        public static Spline CreateQuarterCircleSpline(float radius, float3 position, quaternion rotation, bool invert)
        {
            ...
            var P0 = RotatePointAroundPivot(rotation, new float3(0, 0, a * resizeMultiplier), center) + position;
            var P1 = RotatePointAroundPivot(rotation, new float3(b * resizeMultiplier, 0, c * resizeMultiplier), center) + position;
            var P2 = RotatePointAroundPivot(rotation, new float3(c * resizeMultiplier, 0, b * resizeMultiplier), center) + position;
            var P3 = RotatePointAroundPivot(rotation, new float3(a * resizeMultiplier, 0, 0), center) + position;
        ...
        public static Spline CreateHalfCircleSpline(float radius, float3 position, quaternion rotation, bool invert)
        {
            var resizeMultiplier = radius / a;
            ...
            var P2 = RotatePointAroundPivot(rotation, new float3(c * resizeMultiplier, 0, b * resizeMultiplier), center) + position;
            var P3 = RotatePointAroundPivot(rotation, new float3(a * resizeMultiplier, 0, 0), center) + position;
            var P4 = RotatePointAroundPivot(rotation, new float3(0, 0, -a * resizeMultiplier), center) + position;
            var P5 = RotatePointAroundPivot(rotation, new float3(-b * resizeMultiplier, 0, -c * resizeMultiplier), center) + position;
            ...
            {
                curveKnot01.Position = P4;
                curveKnot02.Position = P3;
                curveKnot03.Position = P0;

                curveKnot01.TangentIn = P4 - P5;
                curveKnot01.TangentOut = P5 - P4;
                curveKnot02.TangentIn = P2 - P3;
                curveKnot02.TangentOut = P3 - P2;
                curveKnot03.TangentIn = P0 - P1;
                curveKnot03.TangentOut = P1 - P0;
            }
        ...
        public static Spline CreateCircleSpline(float radius, float3 position, quaternion rotation, bool invert)
        {
            ...
            var P4 = RotatePointAroundPivot(rotation, new float3(0, 0, -a * resizeMultiplier), center) + position;
            var P5 = RotatePointAroundPivot(rotation, new float3(-b * resizeMultiplier, 0, -c * resizeMultiplier), center) + position;
            var P6 = RotatePointAroundPivot(rotation, new float3(-c * resizeMultiplier, 0, -b * resizeMultiplier), center) + position;
            var P7 = RotatePointAroundPivot(rotation, new float3(-a * resizeMultiplier, 0, 0), center) + position;
            var P8 = RotatePointAroundPivot(rotation, new float3(0, 0, a * resizeMultiplier), center) + position;
            var P9 = RotatePointAroundPivot(rotation, new float3(b * resizeMultiplier, 0, c * resizeMultiplier), center) + position;
        ...
        private static float3 RotatePointAroundPivot(quaternion rotation, float3 point, float3 pivot)
        {
